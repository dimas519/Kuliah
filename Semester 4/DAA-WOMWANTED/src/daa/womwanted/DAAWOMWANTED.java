...
public class DAAWOMWANTED {
    ...
    public static void main(String[] args) {
        ...
        d.telusuriDFS(cari); //menelusuri dfs dari tujuan akhir apakah ada leaf lain selain dia
        
        
        boolean check=true; 
        
        for(boolean logic: d.kunjunganDFS){
            if(!logic){
                check=logic;
            }
        }
