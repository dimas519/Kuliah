...
public class DAAD40 {
    ...
    public static void main(String[] args) {
        ...
        while  (!perintah.equalsIgnoreCase("quit")){
            if(perintah.equalsIgnoreCase("insert")){
                bst.insert(input);
                System.out.println("Nillai "+input+" berhasil dimasukan");
                System.out.println(bst.toString());
            }else if(perintah.equalsIgnoreCase("delete")){
                boolean berhasil= bst.delete(input);
                if(berhasil)
            }
