 ...
 */
package daa.modulmap;

/**
 *
 * @author Dimas Kurniawan
 */
public class DAAModulMAP {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Satu" + h.extractMax());
        h.print();

        h.InsertKey(1);

        System.out.println("dua" + h.extractMax());
        h.print();

        h.InsertKey(3);

        System.out.println("tiga" + h.extractMax());
        h.print();

        h.InsertKey(6);

        System.out.println("empat" + h.extractMax());
        h.print();
